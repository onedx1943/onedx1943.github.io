export default {
    ...
    template: `
        <div>
            <div id="time-axis" class="test-chart time-chart"></div>
            <div id="chart1" class="test-chart"></div>
            <div id="chart2" class="test-chart"></div>
        </div>
    `,
    created: function () {
        // 如何快速创建数组
    ...
    mounted: function () {
        ...
        this.load_time_axis(time_axis, this.chart_data1);
        this.load_chart(chart1, this.chart_data1);
        this.load_chart(chart2, this.chart_data2);
        echarts.connect([time_axis, chart1, chart2]);
    },
    methods: {
        load_time_axis: function (chart, data) {
            let option = {
                dataZoom: {
                    type: 'slider',
        ...
        load_chart: function (chart, data) {
            let option = {
                title: {
                    text: data.name,
                    left: 'center'
